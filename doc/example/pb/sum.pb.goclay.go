...
import (
	...
	"github.com/kkeigenkai/clay/v3/transport/httpclient"
	"github.com/kkeigenkai/clay/v3/transport/httpruntime"
	"github.com/kkeigenkai/clay/v3/transport/httpruntime/httpmw"
...
func (d *SummatorDesc) SwaggerDef(options ...swagger.Option) (result []byte) {
	if len(options) > 0 || len(d.opts.SwaggerDefaultOpts) > 0 {
		var err error
		var s = &spec.Swagger{}
		if err = s.UnmarshalJSON(_swaggerDef_pb_sum_proto); err != nil {
		...
		result = _swaggerDef_pb_sum_proto
	}
	return result
}
